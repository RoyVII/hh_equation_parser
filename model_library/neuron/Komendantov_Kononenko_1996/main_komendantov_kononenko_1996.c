...
void init_vars_params (double ** vars, double ** params) {
	...
	// Variables
	(*vars)[NM_KOMENDANTOV_KONONENKO_1996_V] = 0; // Not set yet
	...
	// Parameters
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_DT] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_I] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_SYN] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_CM] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_NA_V] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_V_NA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_K] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_V_K] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_NA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_B] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_V_B] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_NA_TTX] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_K_TEA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_CA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_V_CA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_G_CA_CA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_K_BETA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_BETA] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_RHO] = 0; // Not set yet
	(*params)[NM_KOMENDANTOV_KONONENKO_1996_K_S] = 0; // Not set yet
}
